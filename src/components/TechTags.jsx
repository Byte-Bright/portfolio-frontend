            ...
            {group.items.map((item, i) => (
              ...
              >
                <span
                  ...
                  hover:bg-teal-600 hover:text-white neon:border-rose-600
                  bg-stone-50 dark:bg-stone-800 space:bg-stone-800 neon:bg-rose-600 text-sm 
                  neon:hover:bg-yellow-400 dark:hover:bg-lime-600 space:hover:bg-violet-400/10 space:hover:text-violet-400 space:hover:border-violet-400
