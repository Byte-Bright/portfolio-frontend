  ...
  return (
    <div ref={ref} className="grid gap-6">
      ...
      <ul className={`space-y-2 fade-up ${inView ? 'is-visible' : ''}`} style={{ transitionDelay: inView ? '500ms' : '0ms' }}>
        ...
        <li>• Created <strong>AI skills</strong> for common web element installation as well as full template installs, collapsing a 10+ step process across multiple files into a single prompt.</li>
      </ul>
    </div>
  )
}
